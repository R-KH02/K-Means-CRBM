function [images] = display_crbm_v3_bases(W, V1, expandfactor, opt_nonneg, cols)
...
if exist('cols', 'var')
    ...
    display_network(reshape(images, size(images,1)*size(images,2), size(images,3),size(images,4)), true, true);
end
